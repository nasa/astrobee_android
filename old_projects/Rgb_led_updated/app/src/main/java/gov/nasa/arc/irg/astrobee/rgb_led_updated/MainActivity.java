...
package gov.nasa.arc.irg.astrobee.rgb_led_updated;
...
public class MainActivity extends RosActivity {
    private static final URI sMasterUri = URI.create("http://10.0.3.1:11311");

    private static final int BLINK_VENDOR_ID = 10168;
    private static final int BLINK_PRODUCT_ID = 493;

    private static final String ACTION_USB_PERMISSION = "gov.nasa.arc.irg.astrobee.rgb_led_updated.USB_PERMISSION";
