...
public class MicrophoneImplementation {
    ...
    // The first trajectory for the robot
...
//     private static Point m_minPoint = new Point(10.20, -9.75, 4.20);
//     private static Point m_maxPoint = new Point(11.40, -3.50, 5.60);
//     // Points in the lawnmower trajectory
//     private static Point POINT_1 = new Point(10.40, -9.00, 5.40);
//     private static Point POINT_2 = new Point(11.40, -9.00, 5.40);
//     private static Point POINT_3 = new Point(11.40, -8.50, 5.40);
//     private static Point POINT_4 = new Point(10.40, -8.50, 5.40);
//     private static Point POINT_5 = new Point(10.40, -8.00, 5.40);
//     private static Point POINT_6 = new Point(11.40, -8.00, 5.40);
//     private static Point POINT_7 = new Point(11.40, -7.50, 5.40);
//     private static Point POINT_8 = new Point(10.40, -7.50, 5.40);
//     // Sound source, just one for now.
//     private static Point source1 = new Point(10.90, -8.25, 6.40);
    
    // Gateway parameters
    // These determine the allowed region of movement
    private static Point m_minPoint = new Point(9.2,  -8.2, 8.2);
    private static Point m_maxPoint = new Point(10.7, -6.6, 8.2);
    // Points in the lawnmower trajectory in the Gateway
    private static Point POINT_a =  new Point(9.4, -8.2, 6.9);
    private static Point POINT_b =  new Point(11.2, -8.2, 6.9);
    private static Point POINT_c =  new Point(11.2, -8.2, 7.6);
    private static Point POINT_d =  new Point(9.4,  -8.2, 7.6);
    private static Point POINT_e =  new Point(9.4,  -8.2, 8.2);
    private static Point POINT_f =  new Point(10.6,  -8.2, 8.2);
    private static Point POINT_g =  new Point(10.6,  -7.7, 8.2);
    private static Point POINT_h =  new Point(9.4,  -7.7, 8.2);
    private static Point POINT_i =  new Point(9.4,  -7.2, 8.2);
    private static Point POINT_j =  new Point(10.6,  -7.2, 8.2);
    private static Point POINT_k =  new Point(10.6,  -6.7, 8.2);
    private static Point POINT_l =  new Point(9.4,  -6.7, 8.2);
    // Another path in the gateway
    private static Point POINT_1 =  new Point(9.2,  -6.6, 8.2);
    private static Point POINT_2 =  new Point(9.2,  -8.2, 8.2);
    private static Point POINT_3 =  new Point(9.7,  -8.2, 8.2);
    private static Point POINT_4 =  new Point(9.7,  -6.6, 8.2);
    private static Point POINT_5 =  new Point(10.2, -6.6, 8.2);
    private static Point POINT_6 =  new Point(10.2, -8.2, 8.2);
    private static Point POINT_7 =  new Point(10.6, -8.2, 8.2);
    private static Point POINT_8 =  new Point(10.6, -6.6, 8.2);
    // Sound source, just one for now.
    private static Point source1 = new Point(10.0, -7.4, 9.2);
    private static Point POINT_x = new Point(10.0, -7.4, 8.2); // for debugging
    ...
    private  MicrophoneImplementation(boolean fastMode, boolean skipGSManager) {
	...
	m_lawnmowerTrajectory
	    = new java.util.ArrayList<Point>(java.util.Arrays.asList(pointArray));
	
	// Sources of sound (for now just one)
    ...
    public static MicrophoneImplementation getInstance(boolean fastMode, boolean skipGSManager) {
        if (instance == null) {
            instance = new MicrophoneImplementation(fastMode, skipGSManager);
        }
        return instance;
    }
	...
	// To have the colors scale nicely. Temporary!
	double minInten = -0.3, minInten2 = 0.3;
	if (soundIntensity < minInten)
	    soundIntensity = minInten;
	soundIntensity = (soundIntensity - minInten)/(1.0 - minInten);
	soundIntensity = soundIntensity * soundIntensity * soundIntensity;
