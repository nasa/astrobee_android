...
public interface BaseRobot {
     ...
     * planner, the move has the following steps:<br/>- If not in holonomic
     * mode, the robot rotates to face the target position.<br/>- Once rotation
     * is complete, the robot translates in a straight line to the target
     * position.<br/>- Once translation is complete, the robot rotates to the
     * target attitude.
     *
     ...
     * HazCam forward in order to enable obstacle detection. When in holonomic
     * mode, the default trapezoidal planner will skip its usual first step of
     * slewing attitude to face toward the target position. Instead, it will
     * generate a trajectory that maintains the robot's previous attitude
     * during translation to the target position.
     *
     ...
     *                position to the target position, with a trapezoidal
     *                velocity profile. If not in holonomic mode, the robot
     *                will rotate to face the target position before beginning
     *                to translate. After translating to the target position,
     *                the robot will turn to face the target
